...
export interface RouterOptions {
  ...
  beta?: number;
  /** Minimum cosine similarity between current and prior turn to blend trajectory. If below threshold, prior trajectory is discarded (default: 0.0 to preserve context across orthogonal follow-ups) */
  ...
  inertiaBonus?: number;
  /** Score multiplier for companion tools connected in the workflow graph (default: 0.0, disabled by default to avoid premature tool execution) */
